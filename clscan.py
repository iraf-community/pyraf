...
class _ComputeEqnScanner_1(_BasicScanner_1):
	...
	def t_ident(self, s, m, parent):
		r'[a-zA-Z\$_][a-zA-Z\$_\d.]*'
		#XXX recent change -- always recognize keywords
		#XXX watch for problems!
		#XXX parent.addIdent(s, usekey=0)
		parent.addIdent(s)
...
class _StrictSwallowNewlineScanner(_BasicScanner_3,_BasicScanner_2,
								_BasicScanner_1):
...
class _SwallowNewlineScanner(_LaxScanner,_StrictSwallowNewlineScanner):
	"""Scanner class where embedded newlines allowed"""
	pass
