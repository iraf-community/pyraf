...
if sys.platform.startswith('win'):
    ...
    if os.path.exists( r'pyraf\lib\pyraf' ) :
        wdprefix = r'pyraf'
    elif os.path.exists( r'lib\pyraf' ) :
        wdprefix = r'.'
    else :
        raise Exception(r'cannot find lib\pyraf or pyraf\lib\pyraf')

    try :
        os.mkdir( wdprefix + r'\wintmp')
    except :
        pass

    try :
        os.remove( wdprefix + r'\wintmp\runpyraf.py')
    except :
        pass

    print wdprefix + r'\lib\pyraf',  wdprefix + r'\wintmp\runpyraf.py'
    shutil.copy( wdprefix + r'\lib\pyraf',  wdprefix + r'\wintmp\runpyraf.py')
...
setupargs = {
    'version' :			    "1.10", # see lib's __init__.py
