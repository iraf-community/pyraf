...
%typemap(python,ignore) char           *L_OUTPUT(char temp)
{
  char temp[99];
  $target = temp;
}
...
%typemap(python,argout) char     *L_OUTPUT
...
%typemap(python,argout) char      *L_OUTPUT_1CHAR

{
    PyObject *o;
    o = PyString_FromStringAndSize($source,1);
    $target = l_output_helper($target,o);
}
...
%typemap(python,ignore) char           *T_OUTPUT(char temp)
{
  char temp[99];
  $target = temp;
}
...
%typemap(python,argout) char     *T_OUTPUT
{
    PyObject *o;
    o = PyString_FromString($source);
    $target = t_output_helper($target, o);
...
%typemap(python,argout) char      *T_OUTPUT_1CHAR
...
%typemap(python,ignore) char               *OUTPUT = char           *L_OUTPUT;
%typemap(python,ignore) char               *OUTPUT_1CHAR = char *L_OUTPUT_1CHAR;
...
%typemap(python,argout) char               *OUTPUT = char           *L_OUTPUT;
%typemap(python,argout) char               *OUTPUT_1CHAR = char *L_OUTPUT_1CHAR;
...
%typemap(python,ignore) char               *OUTPUT = char           *T_OUTPUT;
%typemap(python,ignore) char               *OUTPUT_1CHAR = char *T_OUTPUT_1CHAR;
...
%typemap(python,argout) char               *OUTPUT = char           *T_OUTPUT;
%typemap(python,argout) char               *OUTPUT_1CHAR = char *T_OUTPUT_1CHAR;
...
or you can use the %apply directive :
        ...
        %include typemaps.i
        %apply double *%typemap(python,argout) char               *OUTPUT_1CHAR = char *L_OUTPUT_1CHARINOUT { double *x };
        void neg(double *x);
